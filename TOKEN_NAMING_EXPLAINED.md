...
**Multiple tokens can be named "Bird Token"**:
- Token A: "Bird Token" at `0x111...`
- Token B: "Bird Token" at `0x222...`
- Token C: "Bird Token" at `0x333...`
...
- ✅ **Token Symbol** - Shown in trading pairs (e.g., BIRD/USDC)
...
**For testnet**: Use "Bird Token" - it's fine for testing.
